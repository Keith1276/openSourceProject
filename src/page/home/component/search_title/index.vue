<template>
    <div style="display: flex; flex-direction: column;">
        ...
        <search_bar :cond="cond" style="margin-left: auto; margin-right: auto; margin-top: 25px;"/>

        <div class="mb-2 ml-4" style="margin-top: 15px">
            <el-radio-group v-model="search_select">
                <el-radio value="1" size="large" class="select-font">学术论文</el-radio>
                <el-radio value="2" size="large" class="select-font">专利</el-radio>
                <el-radio value="3" size="large" class="select-font">科研项目</el-radio>
                <el-radio value="4" size="large" class="select-font">奖项</el-radio>
            </el-radio-group>
        </div>
